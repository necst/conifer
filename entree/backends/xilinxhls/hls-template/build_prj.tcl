...
set_top myproject
add_files firmware/BDT.h -cflags "-std=gnu++14"
add_files firmware/myproject.cpp -cflags "-std=gnu++14"
add_files -tb myproject_test.cpp -cflags "-I firmware/ -std=gnu++14"
